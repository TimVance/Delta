...
class Shop_admin_discount_order extends Frame_admin
{
	...
	*/
	...
	public $variables = array (
		'main' => array (
			'mode' => array(
				...
				'name' => 'Тип скидки',
				'select' => array(
					// "discount" => "Постоянные скидки на товары",
			...
			// 	'depend' => 'mode=discount|mode=users',
			// ),
			'amount' => array(
				'type' => 'floattext',
	 ...
	 * @return void
	 */
	private function show_mode_discount()
	{
