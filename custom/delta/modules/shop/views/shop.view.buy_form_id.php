...
echo '<div class="js_shop_buy shop_buy to-cart">';
	...
	{
		echo '<input type="button" class="button solid" value="'.$this->diafan->_('Заказать', false).'" action="buy">';
	}
echo '</div>';
*/
...
{
	echo '<span class="js_shop_one_click shop_one_click"><input class="single-technique__button button" type="button" value="'.$this->diafan->_('Купить в один клик', false).'" action="one_click"></span>';
}
