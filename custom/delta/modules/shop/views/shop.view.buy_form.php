...
{
	echo '<span class="js_shop_one_click shop_one_click"><input class="technique-item__button button" type="button" value="'.$this->diafan->_('Взять в аренду', false).'" action="one_click"></span>';
}
