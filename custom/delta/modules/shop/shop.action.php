...
class Shop_action extends Action
{
    ...
    public function getProductsByCategory() {
        ...
        $this->model->show_block($count, $site_ids, $cat_ids, $ids, $brand_ids, $sort, $images, $images_variation, $param, $hits_only, $action_only, $new_only, $discount_only, $tag);
        $this->model->result();
        $this->model->result["ajax"] = true;
        $this->result["data"] = $this->diafan->_tpl->get('rows_cat_main', 'shop', $this->model->result);
        $this->result["result"] = 'success';
    }
}
