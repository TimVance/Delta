...
{
	echo '<span itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem"><a itemprop="item" href="'.BASE_PATH_HREF.'"><span itemprop="name">'.$this->diafan->_('Главная').'</span><meta itemprop="position" content="'.$position.'"></a> '.$separator.'</span> ';
	$position++;
}
if ($this->diafan->_site->parent_id)
{
	...
	{
		echo '<span itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem"><a itemprop="item" href="'.BASE_PATH_HREF.$row["link"].'"><span itemprop="name">'.$this->diafan->_useradmin->get($row["name"], 'name', $row["id"], 'site', _LANG).'</span><meta itemprop="position" content="'.$position.'"></a> '.$separator.'</span> ';
		$position++;
	}
}
if ($this->diafan->_site->breadcrumb)
{
	foreach ($this->diafan->_site->breadcrumb as $breadcrumb)
	{
		...
		echo '<span itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem"><a itemprop="item" href="'.BASE_PATH_HREF.$breadcrumb["link"].'"><span itemprop="name">'.$breadcrumb["name"].'</span><meta itemprop="position" content="'.$position.'"></a> '.$separator.'</span> ';
		$position++;
	}
}
if($current)
{
	...
	echo '<span itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem"><span itemprop="item"><span itemprop="name">'.$name.'</span><meta itemprop="position" content="'.$position.'"></span></span>';
}
echo '</div>';
