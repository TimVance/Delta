...
class Shop_inc extends Diafan
{
	...
	public function price_calc($good_id = 0, $discount_id = 0, $currency_id = 0)
	{
		...
		." WHERE act='1' AND (date_finish=0 OR date_finish > %d) AND trash='0' AND threshold_cumulative=0 AND threshold=0 AND threshold_goods=0 AND threshold_count=0 AND delivery_id=0 AND payment_id=0".($discount_id ? " AND id=".$discount_id : ''), $time);
